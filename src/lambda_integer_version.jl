function lambda_i_version(generators, nodes, branches, loads, min_load_percent, optimizer = with_optimizer(GLPK.Optimizer, msg_lev = GLPK.MSG_ALL))
    ...
    dual_bilinear_constraints_i(FP, branches)
