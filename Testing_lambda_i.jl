...
BLi = lambda_i_version(generators118, nodes118, branches118, loads118, 0.95, with_optimizer(Gurobi.Optimizer,TimeLimit = 3600));
...
BLi = lambda_i_version(generators118, nodes118, branches118, loads118, 0.90, with_optimizer(Gurobi.Optimizer,TimeLimit = 3600));
...
BLi = lambda_i_version(generators118, nodes118, branches118, loads118, 0.85, with_optimizer(Gurobi.Optimizer,TimeLimit = 3600));
...
BLi = lambda_i_version(generators118, nodes118, branches118, loads118, 0.80, with_optimizer(Gurobi.Optimizer,TimeLimit = 3600));
